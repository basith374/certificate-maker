...
public class ImageSizeDialog extends Stage {
    ...
    private Group imageHolder;

    public void setImageHolder(Group imageHolder) {
    ...
    public ImageSizeDialog(Stage parent, final Window window) {
        primaryStage = parent;
        this.window = window;
        initOwner(parent);
        ...
        onButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent t) {
                if(!"".equals(widthField.getText()) || !"".equals(heightField.getText())) {
                    ...
                    System.out.println("image added : x" + imageX + " y" + imageY + " width" + width + " height" + height + ", group childerns " + imageHolder.getChildren().size()); // debug
                    ImageView image = certificateUtils.createAvatarImage(imageX, imageY, width, height);
